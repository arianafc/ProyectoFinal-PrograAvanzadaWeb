...
/****** Object:  StoredProcedure [dbo].[ObtenerNotasEstudianteSP]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[ObtenerPerfilEstudianteSP]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[RegistrarError]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[RegistroSP]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[RetirarEstudianteSP]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[SubirDocumentosPerfilSP]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER PROCEDURE [dbo].[SubirDocumentosPerfilSP]
(
    @IdUsuario INT,
...
BEGIN
    INSERT INTO Documentos (Documento, Tipo, IdUsuario, FechaSubida)
    VALUES (@Documento, 'Perfil', @IdUsuario, GETDATE());
END
GO
...
/****** Object:  StoredProcedure [dbo].[UltimasPracticasAsignadasSP]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER PROCEDURE [dbo].[UltimasPracticasAsignadasSP]
AS
BEGIN
    SELECT TOP 5
        CONCAT(U.Nombre, ' ', U.Apellido1, ' ', U.Apellido2) AS Estudiante,
...
/****** Object:  StoredProcedure [dbo].[ValidarAplicacionPracticaSP]    Script Date: 12/17/2025 8:16:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
